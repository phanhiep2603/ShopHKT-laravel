...
Route::group(['prefix'=>'admin','middleware'=>'adminLogin'],function() {
	...
	Route::get('dashboard',['as'=>'admin.dashboard','uses'=>'UserController@getDashboard']);
...
Route::get('changepassword',['as'=>'admin.changePassword','uses'=>'changeAdminController@ChangePassword']);
Route::post('changepassword',['as'=>'admin.changePassword','uses'=>'changeAdminController@ChangePasswordSuccessfully']);
Route::get('forgotPassword','Auth\ForgotPasswordController@getFormResetPassword');
Route::post('forgotPassword','Auth\ForgotPasswordController@postResetPassword');
Route::get('password/reset',['as'=>'get.link.reset.password','uses'=>'Auth\ForgotPasswordController@ResetPassword']);
Route::post('password/reset','Auth\ForgotPasswordController@saveRequestPasword');
