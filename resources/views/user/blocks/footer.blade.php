    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 contact col-sm-6">
          <h2>Contact Us </h2>
          <ul>
            <li class="phone"> +84908122860</li>
            <li class="mobile"> ---</li>
            <li class="email"> phanhiep2603@gmail.com</li>
          </ul>
        </div>
...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
        ...
        <div class="fb-like-box" data-href="https://www.facebook.com/HKTShop-100310601690347" data-width="292" data-show-faces="true" data-colorscheme="light" data-stream="false" data-show-border="false" data-header="false"  data-height="240"></div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="copyrightbottom">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 textright"> ShopHKT @ 2020 </div>
      </div>
    </div>
  </section>
