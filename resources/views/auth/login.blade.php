        ...
        <div class="col-lg-12">
          ...
          <section class="returncustomer">
            ...
            <div class="loginbox">
              ...
              <form class="form-vertical" role="form" action="{{ route('login') }}" method="POST">
                ...
                <fieldset>
                  ...
                  <div class="form-group">
                    ...
                    <br>
                    <a class="" href="{!! url('forgotPassword') !!}">Forgot your Password?</a>
                  </div>
          ...
          <section class="newcustomer">
            ...
            <div class="loginbox">
              ...
              <p>Register at Shop Fashion HKT to use the functions on the website and update information of our new products in the fastest way.</p>
              <br>
              <br>
